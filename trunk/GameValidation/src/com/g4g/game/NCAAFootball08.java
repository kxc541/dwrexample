...
public class NCAAFootball08 {
	...
	static {
		...
		try {
			props.load(new FileInputStream(
					GameValidatorConstants.NCAAFOOTBALL08PROPERTIES));
	...
	public static String[] fields = {
			...
			props.getProperty(GameValidatorConstants.QTRLENGTH),
			props.getProperty(GameValidatorConstants.DIFFICULTY),
			props.getProperty(GameValidatorConstants.OPPONENT),
			props.getProperty(GameValidatorConstants.RANK), "" };
