 ...
 * @author Rakesh Ray
 */
public class HibernateProperties implements Serializable {
	 ...
	 * value of given keys.
	 */
	protected static final String propertiesURL = String.valueOf(System.getProperty("HIBERNATE_DIR")).concat("/hibernate.properties");
