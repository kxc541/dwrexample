...
import static com.g4g.utils.G4GConstants.G4GUSERFINANCIAL_LIST_SIZE;
import static com.g4g.utils.G4GConstants.G4GUSERFINANCIAL_LIST_SIZE_CRITERIA;
...
/**
 * The Class to implement service for G4gUserFinancial object.
 * @author Jigar Mistry
 */
public class G4GUserFinancialServiceImpl implements G4GUserFinancialService {

	private static final String UNCHECKED = "unchecked"; //$NON-NLS-1$

	/**
	 * @see com.g4g.services.G4GUserFinancialService#add(com.impessa.worldgaming.client.User)
	 */
	...
	/**
	 * @see com.g4g.services.G4GUserFinancialService#delete(com.impessa.worldgaming.client.User)
	 */
	...
	/**
	 * @see com.g4g.services.G4GUserFinancialService#getList()
	 */
	...
	public List<User> getList() {
		AuditUtil.getInstance().writeLog(
				...
				Level.INFO);
		Session session = HibernateUtil.getSession();
		Query query = session.createQuery(new StringBuffer(SQLConstants.FROM).append(G4GConstants.PLAYERDTO_CAPS).toString());
		Transaction transaction = session.beginTransaction();
		...
		AuditUtil.getInstance().writeLog(AuditUtil.FILE_TYPE_G4G,new StringBuffer (this.getClass().getName() ).append( COLON_WITH_SPACES
				...
				).append( G4GUSERFINANCIAL_LIST_SIZE ).append(list.size()).toString() , Level.INFO);
		AuditUtil.getInstance().writeLog(
				AuditUtil.FILE_TYPE_G4G,
				new StringBuffer (this.getClass().getName() ).append( COLON_WITH_SPACES
						).append( CALLINGMETHOD
	...
	/**
	 * @see com.g4g.services.G4GUserFinancialService#getList(com.g4g.dto.SearchCriteria)
	 */
	@SuppressWarnings(UNCHECKED)
	public List<User> getList(SearchCriteria searchCriteria) {
		...
		try {
			...
			AuditUtil.getInstance().writeLog(AuditUtil.FILE_TYPE_G4G,new StringBuffer (this.getClass().getName() ).append( COLON_WITH_SPACES
					...
					).append( G4GUSERFINANCIAL_LIST_SIZE_CRITERIA ).append(list.size()).toString() , Level.INFO);
			AuditUtil.getInstance().writeLog(
					AuditUtil.FILE_TYPE_G4G,
					new StringBuffer (this.getClass().getName() ).append( COLON_WITH_SPACES
							).append( CALLINGMETHOD
	...
	/**
	 * @see com.g4g.services.G4GUserFinancialService#update(com.impessa.worldgaming.client.User)
	 */
