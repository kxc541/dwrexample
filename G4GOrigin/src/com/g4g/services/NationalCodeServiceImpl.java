...
import static com.g4g.utils.G4GConstants.GIVES_NATION_NAME;
import static com.g4g.utils.G4GConstants.NATIONAL_CODE_LIST_SIZE;
import static com.g4g.utils.G4GConstants.NATIONAL_CODE_LIST_SIZE_CRITERIA;
 ...
 * @author Ankur
 */
public class NationalCodeServiceImpl implements NationalCodeService {
	...
	/**
	 * @see com.g4g.services.NationalCodeService#delete(com.g4g.dto.NationalCodeDTO)
	 */
		...
		AuditUtil.getInstance().writeLog(
				...
				new StringBuffer(this.getClass().getName()).append(COLON_WITH_SPACES)
						.append(CALLINGMETHOD).append(
								...
								CURRENTMETHOD).append(
								DataUtil.getCurrentMethod()).append(DASHES)
						.append(NATIONAL_CODE_LIST_SIZE).append(list.size())
						.toString(), Level.INFO);
		AuditUtil.getInstance().writeLog(
				AuditUtil.FILE_TYPE_G4G,
				new StringBuffer(this.getClass().getName()).append(COLON_WITH_SPACES)
	...
	/**
	 * @see com.g4g.services.NationalCodeService#getList(com.g4g.dto.SearchCriteria)
	 */
	@SuppressWarnings(UNCHECKED)
	public List<NationalCodeDTO> getList(SearchCriteria searchCriteria)
		...
		Session session = HibernateUtil.getSession();
		Criteria criteria = session.createCriteria(NationalCodeDTO.class);
		...
		Transaction transaction = session.beginTransaction();
		List<NationalCodeDTO> list = new ArrayList<NationalCodeDTO>();
		...
		AuditUtil.getInstance().writeLog(
				...
				new StringBuffer(this.getClass().getName()).append(COLON_WITH_SPACES)
						.append(CALLINGMETHOD).append(
								...
								CURRENTMETHOD).append(
								DataUtil.getCurrentMethod()).append(DASHES)
						.append(NATIONAL_CODE_LIST_SIZE_CRITERIA).append(
	...
	/**
	 * @see com.g4g.services.NationalCodeService#update(com.g4g.dto.NationalCodeDTO)
	 */
	 ...
	 */
	public String getNationName(int code) throws HibernateException {
		AuditUtil.getInstance().writeLog(
				AuditUtil.FILE_TYPE_G4G,
				new StringBuffer(this.getClass().getName()).append(COLON_WITH_SPACES)
						.append(CALLINGMETHOD).append(
		...
		Session session = HibernateUtil.getSession();
		Transaction transaction = session.beginTransaction();
		NationalCodeDTO dto = (NationalCodeDTO) session.get(
				NationalCodeDTO.class, code);
		transaction.commit();
		HibernateUtil.closeSession();
		AuditUtil.getInstance().writeLog(
				AuditUtil.FILE_TYPE_G4G,
				new StringBuffer(this.getClass().getName()).append(DASHES)
						.append(GIVES_NATION_NAME).toString(), Level.INFO);
		AuditUtil.getInstance().writeLog(
				AuditUtil.FILE_TYPE_G4G,
				new StringBuffer(this.getClass().getName()).append(COLON_WITH_SPACES)
						.append(CALLINGMETHOD).append(
