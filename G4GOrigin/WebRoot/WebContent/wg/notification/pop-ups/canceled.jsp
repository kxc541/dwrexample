...
<ul class="buttons">
	<li>
		<a href="<%=G4GConstants.GAME_DETAIL%><%=gameDTO.getId()%><%= G4GConstants.THICKBOX %>"
			class="gray" onclick="hideNotification();">Game Details</a>
	</li>
	<li>
		<a href="#" class="green" onclick="hideNotification();">Close</a>
	</li>
</ul>
...
<table class="generalInfo">
	<tbody>
		...
		<tr>
			...
			<td>
				You have a scheduled game/tournament soon
			</td>
		</tr>
		<tr>
			<th scope="row">
