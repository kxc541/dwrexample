...
<h1>
	You've completed a scheduled game/tournament
</h1>
...
<ul class="buttons">
	<li>
		<a href="#" class="gray" onclick="hideNotification();">Leave Feedback</a>
	</li>
	<li>
		<a href="<%=G4GConstants.VIEW_CARD%><%=twoplayermatchDTO.getId()%><%= G4GConstants.THICKBOX %>"
			class="green" onclick="hideNotification();">View Results</a>
	</li>
</ul>
	...
	<tbody>
		<tr>
			<td colspan="2" scope="row">
				We have received your results for your most recent game. Please
		...
		<tr>
			...
			<td>
				<strong><%=gameDTO.getGamename()%></strong>
			</td>
		</tr>
		<tr>
			<th scope="row">
