...
jQuery.extend(jQuery.validator, {
	...
	messages: {
		...
		date18: "You must be at least 18 years old.",
		...
		notWONoSelectionString: "Please make a selection",
	...
	methods: {
		...
		/**
		* Is the birth date (entered date) >= 18
		*/
		date18: function(value, element) {
			return this.required(element) || (new Date(value).addYears(18) <= new Date());
		},
		...
		notWONoSelectionString: function(value, element) {
